...
}; //Took coordinates from tutorial


var google_api_key = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";//Google Maps API Removed for security

var google_api_traffic_model = "best_guess";
var google_api_departure_time = "now";

var user_origin = "40.745908,-73.946989"; //from tutorial
var user_destination = "XXXXXX";

//(URL OF TUTOR) https://maps.googleapis.com/maps/api/directions/json?origin=40.745908,-73.946989&traffic_model=best_guess&key=AIzaSyBz7jVWlbfCrns-aeLFs6cNd51rBmK2dOE&departure_time=now
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    ...
    let speechText =
      "Hello, I am Timmy. You can ask me to read quotes from Einstein or Lincoln, or ask me to get route information.";
    let repromptText =
      "I did not receive any input. You can say, Do you need help?";
...
const Fallback = {
  ...
  handle(handlerInput) {
    ...
    let speechText = "Sorry, I wasn't able to understand what you said.";
